...
<div id="contact-form" class="align">
    <br>
    <div>
        <h4>SEARCH FOR AN AUCTION</h4>
    </div>

    <form method="POST" action="searchauction.action" name="searchauctionform">
        <br>
        <div>
            <label for="name" style="width: 250px;">
                <span class="required">Article Code </span>
                <input type="text" id="name" name="bid" value="" placeholder="Enter a valid code" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
