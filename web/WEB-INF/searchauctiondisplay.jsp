        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><s:url action="searchauction" var="url"/>
            ...
            <div class="container">
                <div class="col-md-8 col-md-offset-1">
                    ...
                    <c:forEach items="${sessionScope.searchauctionbean.searchAuctionList}" var="auctions">
                        <c:out value="Article Code: ${auctions.articlecode}"/><br>
                        <c:out value="Auction ID: ${auctions.auctionid}"/><br>
                        <c:out value="Auction Title: ${auctions.title}"/><br>
                    </c:forEach>
                </div>
