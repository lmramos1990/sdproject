...
<div id="contact-form" class="align">
    <div>
        <h4>BID AN AUCTION</h4>
    </div>

    <form method="POST" action="bid.action" name="bidform">
        <br>
        <div>
            <label for="name" style="width: 250px;">
                <span class="required">ID </span>
                <input type="text" id="name" name="bid" value="" placeholder="Enter a valid id" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>


        <div>
            <label for="amount" class="required" style="width: 250px;">
                <span class="required"> Amount</span>
                <input type="text" id="amount" name="bid" value="" placeholder="Enter a valid id" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        <div>
            <button  name="submit" type="submit" id="submit" >BID</button>
        </div>
