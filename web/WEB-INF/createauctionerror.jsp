...
<div id="contact-form" class="align">
    ...
    <form method="POST" action="createauction.action" name="createauctionform">
        <br>
        <div>
            <label for="article" style="width: 350px;">
                <span class="required">Article Code </span>
                <input type="text" id="article" name="bid" value="" placeholder="Enter a valid code" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        ...
        <div>
            <label for="name" style="width: 350px;">
                <span class="required">Description </span>
                <input type="text" id="name" name="bid" value="" placeholder="Please Enter a Description" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        <div>
            <label for="name" style="width: 350px;">
                <span class="required">Deadline </span>
                <input type="text" id="name" name="bid" value="" placeholder="Enter a valid Deadline" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        <div>
            <label for="name" style="width: 350px;">
                <span class="required">Amount </span>
                <input type="text" id="name" name="bid" value="" placeholder="Enter a valid Amount"  tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        <div>
