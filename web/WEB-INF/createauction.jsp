    ...
    <form method="POST" action="createauction.action" name="createauctionform">
        ...
        <div>
            <label for="description" style="width: 350px;">
                ...
                <input type="text" id="description" name="bid" value="" placeholder="Enter a valid Deadline" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        <div>
            <label for="amount" style="width: 350px;">
                <span class="required">Amount </span>
                <input type="text" id="amount" name="bid" value="" placeholder="Enter a valid Amount" required="required" tabindex="1" autofocus="autofocus" />
            </label>
        </div>
        <div>
