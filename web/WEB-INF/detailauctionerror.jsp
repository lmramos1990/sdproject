        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><s:url action="detailauction" var="url"/>
            ...
            <h4 align="center">An error occurred when searching an auction</h4>
            <div class="container">
                <div class="col-md-8 col-md-offset-1">
                    <h1>Detail Auction</h1>
                    <form action="detailauction.action" method="post" >
                        <div>
                            <input name="auctionid" align="center" type="text" placeholder="Auction ID" required="required" autofocus>
                        </div>
                        <div>
                            <input type="submit" value="Detail Auction">
                        </div>
                    </form>
                </div>
